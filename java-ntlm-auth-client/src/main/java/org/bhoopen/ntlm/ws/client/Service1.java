 ...
 * 
 */
@WebServiceClient(name = "Service1", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://10.10.10.14:8082/Service1.asmx?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://10.10.10.14:8082/Service1.asmx?WSDL");
     ...
     * 
     * @return
     *     returns GreetingServiceImplPortBinding
     */
    @WebEndpoint(name = "GreetingServiceImplPortBinding")
    public GreetingServiceImplPortBinding getGreetingServiceImplPortBinding() {
        return super.getPort(new QName("http://tempuri.org/", "GreetingServiceImplPortBinding"), GreetingServiceImplPortBinding.class);
    }
     ...
     */
    @WebEndpoint(name = "GreetingServiceImplPortBinding")
    public GreetingServiceImplPortBinding getGreetingServiceImplPortBinding(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "GreetingServiceImplPortBinding"), GreetingServiceImplPortBinding.class, features);
    }
