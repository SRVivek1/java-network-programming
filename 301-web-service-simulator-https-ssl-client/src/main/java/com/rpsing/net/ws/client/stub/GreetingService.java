 ...
 * 
 */
@WebServiceClient(name = "GreetingService", targetNamespace = "http://rpsoft.com/ws/greeting", wsdlLocation = "file:/C:/Windows/SystemD/WorkSpaces/workspace/java-network-programming/301-web-service-simulator-https-ssl/src/main/resource/wsdl/HelloService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Windows/SystemD/WorkSpaces/workspace/java-network-programming/301-web-service-simulator-https-ssl/src/main/resource/wsdl/HelloService.wsdl");
